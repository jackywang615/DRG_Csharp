namespace drg_group.chs_drg_11{
    public class JA1
    {
        ...
        {
            String[] adrg_zd={"C50.900x005","C50.804","D04.501","C50.100","C50.001","C79.806","C50.801","C50.800x005","D05.100","C50.200","C50.600","D03.501","C79.200x007","C50.400","C50.500","C50.800","C50.902","C50.000","C50.900","C44.501","D05.900","C50.000x001","D05.000","C50.300","C50.901","C50.802","C50.803"};
            String[] adrg_zd1={};
        ...
        HashSet<String> ss_matched=record.ssList.Where(x=>adrg_ss.Contains(x)).Select(x=>adrg_ss1[Array.IndexOf(adrg_ss,x)]).ToHashSet();
            ...
            if (true && adrg_zd.Contains(record.zdList[0]) && ((ss_matched.Contains("1") && ss_matched.Contains("2")) || (ss_matched.Contains("1") && ss_matched.Contains("3") && ss_matched.Contains("4")))){
