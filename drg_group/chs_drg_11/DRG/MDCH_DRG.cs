namespace drg_group.chs_drg_11
{
    public class MDCH_DRG 
    {
        ...
        public static bool HR19_group(MedicalRecord record){
            return true;
        }
    
        public static bool HB11_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
    
        public static bool HC11_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
        ...
        public static bool HS11_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
        ...
        public static bool HS33_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
        ...
        public static bool HB15_group(MedicalRecord record){
            return true;
        }
    
        public static bool HC15_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool HS15_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool HS35_group(MedicalRecord record){
            return true;
        }
