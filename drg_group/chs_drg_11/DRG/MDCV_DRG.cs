namespace drg_group.chs_drg_11
{
    public class MDCV_DRG 
    {
        ...
        public static bool VS19_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool VZ11_group(MedicalRecord record){
            return record.zdList.Length>1 && Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]);
        }
    
        public static bool VC13_group(MedicalRecord record){
        ...
        public static bool VT13_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool VZ13_group(MedicalRecord record){
            return record.zdList.Length>1 && (Base.has_mcc(record.Index,record.zdList[0],record.zdList[1..]) || Base.has_cc(record.Index,record.zdList[0],record.zdList[1..]));
        }
    
        public static bool VC15_group(MedicalRecord record){
            return true;
        }
        ...
        public static bool VZ15_group(MedicalRecord record){
            return true;
        }
